 ...
 *
 */
public class BajarElevador extends Command {
	Elevador elevador;
    public BajarElevador() {
    //Usar requires() aqui para declarar las dependencias de un subsistema
        requires(Robot.elevador);
        elevador = Robot.elevador;
    }
    //Llama justo antes de que el comando se ejecute por primera vez
    protected void initialize() {
    	Robot.elevador.set(-SmartDashboard.getNumber("Potencia Elevador", 0.75) * 0.65);
    }
